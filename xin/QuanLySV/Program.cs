...
namespace QuanLySV
{
    class Program
    {
        ...
        static void deleteStudent()
        {
            ...
            SinhVien x = new SinhVien(sid);
            int index = listStudent.IndexOf(x);
            //int index = findStudentByID(sid);cái này mình nghĩ hơi dài vì còn phải tạo phương thức tìm kiếm
        ...
        static void searchStudent()
        {
            ...
            //findStudentByID(sid);
            SinhVien s = new SinhVien(sid);
            int index = listStudent.IndexOf(s);
